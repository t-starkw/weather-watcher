# Weather Watcher
>### Module 6 UNC Coding Bootcamp Challenge - Weather Dashboard <br><br>
...
```sh
git clone git@github.com:t-starkw/weather-watcher.git
```


## Usage

Use the search bar to select a city of your choice, and view the weekly forecast.
...
1. Fork it (<https://github.com/t-starkw/weather-watcher/fork>)
